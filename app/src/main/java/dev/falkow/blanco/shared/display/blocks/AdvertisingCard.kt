...
import dev.falkow.blanco.shared.types.AdvertisingCard

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun AdvertisingCard(
    advertisingCard: dev.falkow.blanco.shared.types.AdvertisingCard,
    onClick: () -> Unit
) {
    OutlinedCard(
        onClick = { onClick() },
        ...
        Column(
            ...
            Text(
                text = "" + Html.fromHtml(advertisingCard.title, 0),
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(8.dp),
            ...
            Text(
                text = advertisingCard.description,
                modifier = Modifier
                    .fillMaxSize()
