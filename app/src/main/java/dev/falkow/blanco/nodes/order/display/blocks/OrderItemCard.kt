package dev.falkow.blanco.nodes.order.display.blocks
        ...
        Column(
            ...
            AsyncImage(
                model = ImageRequest.Builder(context = LocalContext.current)
                    .data("https://blanco.moscow/data/190214/1920391482857183-80x80.jpg")
            ...
            Text(
                // text = (orderItem.price.number ?: "0") + "руб.",
                text = orderItem.price.number + "руб.",
                modifier = Modifier
                    .fillMaxSize()
